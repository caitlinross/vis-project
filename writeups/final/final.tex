...
%     \subfloat[][osage plain]{\epsfig{file=class-net/class-net-Datastructures-osage.png, height=1.5in, width=1.80in}\label{vis-100-0}}\\
     \subfloat[][dot]{\epsfig{file=debug1.png, height=3.0in, width=3.0in}\label{vis-50-1}}
     \subfloat[][circo]{\epsfig{file=debug2.png, height=3.0in, width=3.0in}\label{vis-90-1}}\\
